 ...
 */
final class Version20181106224026 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE referentiel_code_rome (id INT AUTO_INCREMENT NOT NULL, domaine_professionel_id INT DEFAULT NULL, code_rome VARCHAR(255) NOT NULL, code_fiche_em INT NOT NULL, code_ogr INT NOT NULL, libelle_rome VARCHAR(255) NOT NULL, statut INT NOT NULL, INDEX IDX_662A1E94CF3608DA (domaine_professionel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE domaine_professionnel (id INT AUTO_INCREMENT NOT NULL, code_domaine_professionnel VARCHAR(255) NOT NULL, libelle_domaine_professionnel VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE referentiel_code_rome ADD CONSTRAINT FK_662A1E94CF3608DA FOREIGN KEY (domaine_professionel_id) REFERENCES domaine_professionnel (id)');
    }
